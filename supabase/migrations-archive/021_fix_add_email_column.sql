-- Fix: Add email column to user_profile table if it doesn't exist

-- Add email column to user_profile table (safe - won't fail if exists)
DO $$ 
BEGIN
...
-- Recreate the assign_user_role_with_org function with email support
...
-- Recreate get_user_roles_with_org function with email
