...
interface NavigationItem {
  ...
  },
  {
    id: 'video-security',
    name: 'אבטחת וידאו',
    href: '/admin/video-security',
    description: 'מעקב ובקרה על פעילות צפייה חשודה',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2" />
      </svg>
    )
  },
  {
    id: 'video-grading',
    name: 'ציוני צפייה',
    href: '/admin/video-grading',
    description: 'הגדרת פרמטרי ציון ומעקב אחר התקדמות בצפייה',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
  ...
  },
  {
    ...
    name: 'אופטימיזציה',
    href: '/admin/video-optimization',
    description: 'ניהול ביצועים ואופטימיזציה של מערכת הוידאו',
    adminOnly: true,
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 'video-sync',
    name: 'סנכרון וידאו',
    href: '/admin/video-sync',
    description: 'סנכרון טבלאות וידאו ופתרון בעיות מעקב',
    adminOnly: true,
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'כלי לבדיקת בעיות אימות במערכת מעקב הווידאו',
    adminOnly: true,
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
