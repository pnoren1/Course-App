...
export default function LessonItem({
  ...
  return (
    ...
    } ${lesson.is_lab ? "border-l-4 border-l-blue-300" : ""}`}>
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 mb-1">
              ...
              {lesson.is_lab && (
                <span className="inline-flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-blue-100 to-blue-50 text-blue-700 border border-blue-200 rounded-md text-xs font-semibold">
              ...
              {isOpen && (
                <span className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-lg text-xs font-medium border ${
                  lesson.is_lab 
                    ...
                    : "bg-gradient-to-r from-indigo-50 to-indigo-25 text-indigo-700 border-indigo-200"
                }`}>
              ...
              className={`inline-flex items-center justify-center w-10 h-10 rounded-xl transition-all duration-200 border ${
                isOpen 
                  ? lesson.is_lab
                    ...
                    : "bg-gradient-to-br from-indigo-100 to-indigo-50 text-indigo-600 rotate-90 border-indigo-200"
